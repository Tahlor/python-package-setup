...
setup(name='my_pkg',
      version='0.1.1',
      description=' This is a demonstrative package.',
...
script, [firstcode.py](../learning/firstcode.py), located in the package folder:
...
```
getting_started/learning/firstcode.py
```

The contents of firstcode.py should be:
...
insure that it functions properly.
 ...
 Now navigate into the folder `cd 'my_repo'` then enter
...
here](https://github.com/andrewhuynguyen/getting-started/issues) describing
your problem and I will get back to you ASAP.
