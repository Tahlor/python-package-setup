...
testmode = False
"""bool: when True, the package is running in unit test mode; this changes the
behavior of requests to remote resources to use local emulators instead.
"""

def set_testmode(mode_):
    """Sets the unit testing mode of the package.
    """
    global testmode
    testmode = mode_
